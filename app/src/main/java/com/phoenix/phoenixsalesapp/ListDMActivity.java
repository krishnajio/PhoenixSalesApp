...
public class ListDMActivity extends AppCompatActivity {

    Button btnShowdmData;
    TextView tvdmName;
    ImageView btnGetdmdate;
    EditText edtxtdmDate;
    ListView listViewdmData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_dm);

        btnShowdmData = (Button)findViewById(R.id.btnShowdepositeData);
        tvdmName = (TextView)findViewById(R.id.tvuserdm);
        btnGetdmdate = (ImageView)findViewById(R.id.btnGetdmdata);
        edtxtdmDate = (EditText)findViewById(R.id.dtpdmDate);
        listViewdmData = (ListView)findViewById(R.id.listdm);
        ...
        tvdmName.setText("User:- " + UserName + "   Area Name:- " + AreaName);
        items= new ArrayList<HashMap<String, String>> ();

    }

    public void GetDMDate(View view) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                edtxtdmDate.setText((monthOfYear + 1) + "-" + dayOfMonth + "-" + year);
            }
        }, mYear, mMonth, mDay);
        datePickerDialog.show();
    }//end b

    public void ShowDmdata(View view)
    {
        ShowDMData showDMData = new ShowDMData();
        showDMData.execute(AreaCode,UserName,edtxtdmDate.getText().toString());
    }
    private class ShowDMData extends AsyncTask<String, String, String> {
        String resultedData="";
        @Override
        protected void onPreExecute() {
            pDialog = new ProgressDialog(ListDMActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            String url_string = "http://117.240.18.180:91/mynew.asmx/ShowDMData";
            try {
        ...
        protected void onPostExecute(String r) {
            pDialog.dismiss();
           //  Toast.makeText(ListDMActivity.this, r, Toast.LENGTH_SHORT).show();
            jobj = new JSONObject();
            if (r != "") {
                ...
                try {
                    ...
                    JSONArray jarray1 = object.getJSONArray("DMData");
                    items.clear();
                    ...
                    for (int i = 0; i < jarray1.length(); i++) {
                        ...
                        contact.put("TrNo", "DMNo: " + jobj.getString("DMNo"));
                        contact.put("TrDate", "DMDate: " + jobj.getString("DMDate"));
                        contact.put("TrAmt", "TotalChicks: " + jobj.getString("TotalChicks"));
                        contact.put("-", "Mortality: " + jobj.getString("Mortality"));
                        items.add(contact);
                    ...
                    listViewdmData.setAdapter(adapter);
